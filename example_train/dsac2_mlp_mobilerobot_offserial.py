...
if __name__ == "__main__":
    ...
    parser.add_argument("--env_id", type=str, default="pyth_mobilerobot_single", help="env id")
    parser.add_argument("--algorithm", type=str, default="DSAC2", help="RL algorithm")
    parser.add_argument("--enable_cuda", default=True, help="Enable CUDA")
    parser.add_argument("--seed", default=2, help="seed")
    parser.add_argument("--forward_KL", type=bool, default=False)
    parser.add_argument("--ref_action_reg", type=bool, default=True)
    parser.add_argument("--grid_num_per_dim", type=int, default=7)
    parser.add_argument("--spectrum_norm", type=bool, default=True)
    parser.add_argument("--sub_policy_num", type=int, default=2)

    ################################################
    # 1. Parameters for environment
    parser.add_argument("--vector_env_num", type=int, default=16, help="Number of vector envs")
    ...
    parser.add_argument(
        "--gate_policy_hidden_activation", type=str, default="relu", help="Options: relu/gelu/elu/selu/sigmoid/tanh"
    )
    ...
    parser.add_argument("--policy_learning_rate", type=float, default=8e-4)
