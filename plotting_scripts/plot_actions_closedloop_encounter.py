...
for enum, file in enumerate(file_list[0]):
    ...
    x_encounter = np.loadtxt("./figures/MUPO-pyth_encounter/" + file + "/State-1.csv", delimiter=",", skiprows=1)[0][1:]
    y_encounter = np.loadtxt("./figures/MUPO-pyth_encounter/" + file + "/State-2.csv", delimiter=",", skiprows=1)[0][1:]
    steer_encounter = np.loadtxt("./figures/MUPO-pyth_encounter/" + file + "/Action-1.csv", delimiter=",", skiprows=1)[1:]
    acc_encounter = np.loadtxt("./figures/MUPO-pyth_encounter/" + file + "/Action-2.csv", delimiter=",", skiprows=1)[1:]
    # time_step = 0.1s
...
for enum, file in enumerate(file_list[1]):
    ...
    data_x = np.loadtxt("./figures/DSAC2-pyth_encounter/" + file + "/State-1.csv", delimiter=",", skiprows=1)[0][1:]
    data_y = np.loadtxt("./figures/DSAC2-pyth_encounter/" + file + "/State-2.csv", delimiter=",", skiprows=1)[0][1:]
    data_steer = np.loadtxt("./figures/DSAC2-pyth_encounter/" + file + "/Action-1.csv", delimiter=",", skiprows=1)[1:]
    data_acc = np.loadtxt("./figures/DSAC2-pyth_encounter/" + file + "/Action-2.csv", delimiter=",", skiprows=1)[1:]
    time = np.arange(0, len(x_encounter) * 0.1, 0.1)
...
plt.savefig("./figures/encounter_closedloop_action_comparing.pdf", bbox_inches='tight', dpi=300)
plt.close()
######################################################################################################
...
for enum, file in enumerate(file_list[0]):
    order = len(file_list[0]) - enum
    data_x = np.loadtxt("./figures/MUPO-pyth_encounter/" + file + "/State-1.csv", delimiter=",", skiprows=1)[0][1:]
    data_y = np.loadtxt("./figures/MUPO-pyth_encounter/" + file + "/State-2.csv", delimiter=",", skiprows=1)[0][1:]
    data_phi = np.loadtxt("./figures/MUPO-pyth_encounter/" + file + "/State-3.csv", delimiter=",", skiprows=1)[0][1:]
...
for enum, file in enumerate(file_list[1]):
    ...
    data_x = np.loadtxt("./figures/DSAC2-pyth_encounter/" + file + "/State-1.csv", delimiter=",", skiprows=1)[0][1:]
    data_y = np.loadtxt("./figures/DSAC2-pyth_encounter/" + file + "/State-2.csv", delimiter=",", skiprows=1)[0][1:]
    data_phi = np.loadtxt("./figures/DSAC2-pyth_encounter/" + file + "/State-3.csv", delimiter=",", skiprows=1)[0][1:]
    ego_x_5sec = data_x[50]
    ego_y_5sec = data_y[50]
    ego_phi_5sec = data_phi[50]
...
plt.savefig("./figures/encounter_closedloop_position_comparing.pdf", bbox_inches='tight', dpi=300)
plt.close()