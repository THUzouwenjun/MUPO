...
for enum, file in enumerate(file_list[0]):
    ...
    x_bypass = np.loadtxt("./figures/MUPO-pyth_bypass/" + file + "/State-1.csv", delimiter=",", skiprows=1)[0][1:]
    y_bypass = np.loadtxt("./figures/MUPO-pyth_bypass/" + file + "/State-2.csv", delimiter=",", skiprows=1)[0][1:]
    steer_bypass = np.loadtxt("./figures/MUPO-pyth_bypass/" + file + "/Action-1.csv", delimiter=",", skiprows=1)[1:]
    acc_bypass = np.loadtxt("./figures/MUPO-pyth_bypass/" + file + "/Action-2.csv", delimiter=",", skiprows=1)[1:]
    # time_step = 0.1s
...
for enum, file in enumerate(file_list[1]):
    ...
    data_x = np.loadtxt("./figures/DSAC2-pyth_bypass/" + file + "/State-1.csv", delimiter=",", skiprows=1)[0][1:]
    data_y = np.loadtxt("./figures/DSAC2-pyth_bypass/" + file + "/State-2.csv", delimiter=",", skiprows=1)[0][1:]
    data_steer = np.loadtxt("./figures/DSAC2-pyth_bypass/" + file + "/Action-1.csv", delimiter=",", skiprows=1)[1:]
    data_acc = np.loadtxt("./figures/DSAC2-pyth_bypass/" + file + "/Action-2.csv", delimiter=",", skiprows=1)[1:]
    time = np.arange(0, len(x_bypass) * 0.1, 0.1)
...
plt.savefig("./figures/bypass_closedloop_action_comparing.pdf", bbox_inches='tight', dpi=300)
plt.close()
######################################################################################################
...
for enum, file in enumerate(file_list[0]):
    order = len(file_list[0]) - enum
    data_x = np.loadtxt("./figures/MUPO-pyth_bypass/" + file + "/State-1.csv", delimiter=",", skiprows=1)[0][1:]
    data_y = np.loadtxt("./figures/MUPO-pyth_bypass/" + file + "/State-2.csv", delimiter=",", skiprows=1)[0][1:]
    linestyle = (0, (3, 3)) if enum == 0 else '-'
...
plt.savefig("./figures/bypass_closedloop_position_comparing.pdf", bbox_inches='tight', dpi=300)
plt.close()