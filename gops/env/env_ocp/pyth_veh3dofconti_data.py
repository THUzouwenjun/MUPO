...
class SimuVeh3dofconti(PythBaseEnv):
    ...
    def set_is_closed_loop(self, is_closed_loop: str):
    ...
    def render(self, mode="human"):
        ...
        draw_center_x = 15
        draw_center_y = 3
        # draw_center_x = ego_x + 5 * np.cos(self.state[2])
        # draw_center_y = ego_y + 5 * np.sin(self.state[2])
