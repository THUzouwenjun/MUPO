...
if __name__ == "__main__":
    ...
    parser.add_argument("--env_id", type=str, default="pyth_encounter", help="RL env")
    parser.add_argument("--algorithm", type=str, default="DSAC2", help="RL algorithm")
    parser.add_argument("--enable_cuda", default=False, help="Enable CUDA")
    parser.add_argument("--seed", default=4, help="seed")
    parser.add_argument("--spectrum_norm", type=bool, default=False)
    parser.add_argument("--policy_Lipschitz_constant", type=float, default=5.0)
    ...
    parser.add_argument("--final_lr_decay", type=float, default=0.01)
