...
class MultiRefTrajModel:
    def __init__(
        ...
        self.ref_trajs: Sequence[RefTrajModel] = [
            ...
            SineRefTrajModel(ref_speeds, **self.path_param["sine2"]),
            DoubleLaneRefTrajModel(ref_speeds, **self.path_param["double_lane2"]),
            TriangleRefTrajModel(ref_speeds, **self.path_param["triangle2"]),
            DoubleLaneRefTrajModel(ref_speeds, **self.path_param["double_lane3"]),
        ]
